...
AND LOWER(sch_isole_a_partir_de) SIMILAR TO '%(wheat|meat|cheese|fromage|poivre|milk|beaufort|wine|rice|salad|tomate|steak|vegetable|sauce|beef|pork|cultivated|chickpea|apple)%'
