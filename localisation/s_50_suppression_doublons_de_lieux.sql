...
/* je vire les 95 doublons de lieux du dico qui ne sont pas utilisés comme sch_lieu dans t_souche */
DELETE FROM ids_a_changer WHERE ids_a_changer.id1 NOT IN (SELECT sch_lieu FROM t_souche WHERE sch_lieu IS NOT NULL);
