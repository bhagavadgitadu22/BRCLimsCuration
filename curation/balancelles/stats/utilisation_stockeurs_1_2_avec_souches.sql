...
SELECT rangement.xxx_id, level, lst_nom, ARRAY_TO_STRING(name_path, ' > '), lts_cst_id, sch_identifiant, COUNT(*)
FROM rangement
...
GROUP BY rangement.xxx_id, level, lst_nom, name_path, lts_cst_id, sch_identifiant
ORDER BY ARRAY_TO_STRING(name_path, ' > '), lts_cst_id