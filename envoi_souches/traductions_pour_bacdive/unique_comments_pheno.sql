SELECT btrim(cpr_com), ARRAY_AGG(DISTINCT t_carac_phenotypique_resultat.xxx_id)
...
AND btrim(cpr_com) SIMILAR TO '%[a-zA-Z]+%'
GROUP BY btrim(cpr_com)
ORDER BY btrim(cpr_com);