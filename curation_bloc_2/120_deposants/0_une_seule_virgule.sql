...
UPDATE t_donneedico
SET don_lib = 'K. Rose, IMMB Westfälische Wilhelms Münster University'
WHERE don_dic_id = 104
AND don_lib = 'K. Rose, IMMB, Westfälische Wilhelms Münster University';
...
UPDATE t_donneedico
SET don_lib = 'K. Trülzsch, Max von Pettenkofer Institute of Munich University'
WHERE don_dic_id = 104
AND don_lib = 'K. Trülzsch, Max von Pettenkofer Institute, Munich University';

UPDATE t_donneedico
SET don_lib = 'A. Steinbüchel, Munster (Germany)'
WHERE don_dic_id = 104
AND don_lib = 'A. Steinbüchel, Munster, Germany';
