...
def sheet_error(wb, cursor, file, name):
    cursor.execute(open("../analyse/analyse_milieux_culture/"+file, "r").read())
...
def create_excel(path):
    ...
    wb = Workbook()
    sheet_error(wb, cursor, "35_repetition_ingredients_avec_quantites_et_unites.sql", "recettes_eclatees")

    del wb["Sheet"]
    wb.save(str(path))

create_excel(r"C:\Users\Public\Documents\analyse_redondance_milieux_hugo.xlsx")