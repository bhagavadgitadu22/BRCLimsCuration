...
xls_ids = pd.ExcelFile(r"C:\Users\Public\Documents\souches_les_plus_commandees.xlsx")
xls_packs = pd.ExcelFile(r'C:\Users\Public\Documents\Panels_WGS.xlsx')
...
with pd.ExcelWriter(r"C:\Users\Public\Documents\max_commandes_vs_packs.xlsx") as writer:
