...
try:
    ...
    cursor.execute(open("../localisation/18_trim_elements_localisation.sql", "r").read())
    ...
    cursor.execute(open("../localisation/35_virer_erreurs_orthographe_pays.sql", "r").read())
    ...
    cursor.execute(open("../localisation/36_autres_erreurs_orthographe.sql", "r").read())
    ...
    cursor.execute(open("../localisation/41_separation_ville_de_pays_pour_format_virgule_inverse.sql", "r").read())
